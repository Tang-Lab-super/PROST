...
from . utils import mclust



class PROST_NN(nn.Module):
    def __init__(self, nfeat, embedding_size, dropout=0.05, leaky_alpha=0.15, beta = 0.5, cuda=False):
        ...
        self.gal = GraphAttentionLayer(nfeat, embedding_size, dropout, leaky_alpha).to(self.device)
