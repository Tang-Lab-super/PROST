...
def simulateH5Data(adata, rr=0.05, mu=0, sigma=1, alpha=0.1):
    """
        adata : H5 object
        rr : dropout rate
        mu : Mean of the Gaussian noise
        sigma : Variance of the Gaussian noise
        alpha : Scale of the Gaussian noise
    """
    if rr > 1 or rr < 0:
        print("Warning! Dropout rate is illegal!")
        return 0
    print("runing simulateH5Data...")
    ...
    print(f"Add Gaussian noise: {alpha} * gauss({mu}, {sigma}).")
